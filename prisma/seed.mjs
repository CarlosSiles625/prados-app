...
export const FILOSOFIAHTML = `<h2 style='margin:0cm;text-align:center;font-size:13px;font-family:"Times New Roman",serif;'><em><span style="font-size:15px;"><strong>FILOSOFIA &nbsp;DE&nbsp;</strong></span></em></h2>
    <h2 style='margin:0cm;text-align:center;font-size:13px;font-family:"Times New Roman",serif;'><em><strong>PROGRAMA DE RESTAURACI&Oacute;N DE ALCOHOLICOS Y DROGADICTOS</strong></em></h2>
    <h1 style='margin:0cm;text-align:justify;font-size:16px;font-family:"Times New Roman",serif;font-weight:normal;'><strong><span style="font-size:15px;">&nbsp;</span></strong></h1>
    <h1 style='margin:0cm;text-align:justify;font-size:16px;font-family:"Times New Roman",serif;font-weight:normal;margin-left:36.0pt;'><span style="font-size:15px;">Es un programa &nbsp; dedicado &nbsp;a la restauraci&oacute;n &nbsp;de alcoh&oacute;licos &nbsp;y drogadictos.&nbsp;</span></h1>
    <ol>
        <ul style="list-style-type: circle;">
            <ul style="list-style-type: circle;">
                <li>
                    <h1 style='margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; text-align: left; font-size: 16px; font-family: "Times New Roman", serif; font-weight: normal;'><span style="font-size:15px;">Reconocemos que la adicci&oacute;n es un s&iacute;ntoma de otros problemas.</span></h1>
                </li>
                <li>
                    <h1 style='margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; text-align: left; font-size: 16px; font-family: "Times New Roman", serif; font-weight: normal;'><span style="font-size:15px;">Reconocemos que los &nbsp;problemas &nbsp; incluyen el f&iacute;sico, espiritual, mental, psicol&oacute;gico y social.&nbsp;</span></h1>
                </li>
                <li>
                    <h1 style='margin-top: 0cm; margin-right: 0cm; margin-bottom: 0cm; text-align: left; font-size: 16px; font-family: "Times New Roman", serif; font-weight: normal;'><span style="font-size:15px;">Reconocemos que la restauraci&oacute;n no solo es cesaci&oacute;n de la adicci&oacute;n, sino el cambio de los &nbsp; &nbsp; pensamientos que llevan a la persona &nbsp;a la adici&oacute;n.</span><span style="font-size:15px;">&nbsp;</span></h1>
                </li>
            </ul>
        </ul>
    </ol>
    <h1 style='margin:0cm;text-align:justify;font-size:16px;font-family:"Times New Roman",serif;font-weight:normal;text-indent:36.0pt;'><span style="font-size:15px;">Estamos &nbsp; dedicados a trabajar &nbsp;en todas sus &aacute;reas &nbsp;para efectuar &nbsp;una restauraci&oacute;n verdadera de las adicciones.</span></h1>
    <p style='margin:0cm;text-align:justify;font-size:13px;font-family:"Times New Roman",serif;'><span style="font-size:15px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; PRADOS, es una instituci&oacute;n Cristiana &nbsp;por lo tanto nos apoyamos &nbsp;en el poder &nbsp; de Jesucristo, para traer cambios &nbsp; en &nbsp;la &nbsp;vida del individuo. El proceso normalmente dura ocho meses m&iacute;nimo; Por lo tanto la persona que ingresa a PRADOS debe desear un cambio &nbsp;en su vida, y aceptar &nbsp;que por lo menos tiene que permanecer este tiempo. &nbsp;</span></p>
